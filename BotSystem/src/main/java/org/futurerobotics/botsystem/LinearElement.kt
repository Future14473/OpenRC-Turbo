 ...
 */
abstract class LinearElement : BaseElement() {
    ...
    /**
     * Pauses running until started, or until the current thread
     * is interrupted.
     */
    protected fun waitForStart(): Unit = try {
        botSystem.waitForStartBlocking()
     ...
     * @see isStopRequested
     */
    protected fun isStarted(): Boolean = botSystem.isStarted || isStopRequested()
